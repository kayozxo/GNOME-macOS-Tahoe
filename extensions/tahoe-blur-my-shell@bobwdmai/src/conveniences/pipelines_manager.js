...
/// memory. It is meant to *always* be in sync with the `org.gnome.shell.extensions.tahoe-blur-my-shell`'s
...
export class PipelinesManager {
    ...
    _log(str) {
        if (this.settings.DEBUG)
            console.log(`[Tahoe Blur > pipelines]    ${str}`);
    }

    _warn(str) {
        console.warn(`[Tahoe Blur > pipelines]    ${str}`);
    }
}
